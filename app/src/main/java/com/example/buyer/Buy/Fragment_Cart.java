...
//        isAccessory=getArguments().getString("isAccess");
    ...
    public void loadCart()
    {
        ...
        String url= Constants.ROOT_URL+"fetch_cart_items.php?id="+user_id;
...
//                                brand_id=product.getString("brand_id");
                                ...
                                cartItemClass=new CartItemClass( id,brandname,  modelname,  color, storage,  price ,image,is_pta_approved,quantityI,seller_id);
...
//            Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            myViewHolder.btnbuyproduct.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(getActivity(),aList.get(i).getSeller_id(),Toast.LENGTH_SHORT).show();
...
public void removeCartItem(String id)
{
    ...
    progressDialog.show();
    RequestQueue queue = Volley.newRequestQueue(getContext());
    String url= Constants.ROOT_URL+"delete_cart_item.php?id="+id;
