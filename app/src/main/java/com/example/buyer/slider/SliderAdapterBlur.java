...
public class SliderAdapterBlur extends
        SliderViewAdapter<SliderAdapterBlur.SliderAdapterVH> {
    ...
    public SliderAdapterBlur(ArrayList<SliderItem> aList,Context context) {
        this.aList=aList;
